...
class AgencyController extends Controller
{
    ...
    public function addAgencyWalletBalance($id ,Request $request){
        ...
        $walletLogger->amount = $amount;
        $walletLogger->remaining_amount = $amount + $agency->masterAgent->wallet_balance;
        $walletLogger->amount_description = !empty($request->description)? $request->description : $amount." Add Wallet Balance";
        $walletLogger->action = 'added';
        $walletLogger->status = 'Active';
        $walletLogger->date_of_transaction = now();
