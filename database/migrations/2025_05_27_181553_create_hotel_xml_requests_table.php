...
class CreateHotelXmlRequestsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('hotel_xml_requests', function (Blueprint $table) {
            ...
            $table->enum('request_type',['search','getRooms','getRoomsWithBlocking','confirmBooking','cancelBooking','getbookingdetails','saveBooking','cancelbookingNo','cancelbookingYes','prebooking','bookingSearch'])->nullable();
