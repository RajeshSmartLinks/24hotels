                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" action="{{route('appads.update', $editAds->id)}}" method="post"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class= "col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="link" class="form-control" placeholder="Order" name="link" value="{{$editAds->link}}" autocomplete="off">
                                                ...
                                                <div class="row">
                                                    <div class= "col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="status" class="form-control @error('status') is-invalid @enderror" id="basicSelect">
                                                                ...
                                                                <option value="Active" {{($editAds->status == "Active")?"selected":""}}>Active</option>
                                                                <option value="InActive" {{($editAds->status == "InActive")?"selected":""}}>InActive</option>
                                                            </select>
                                                            @error('status')
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="sort_order" class="form-control @error('sort_order') is-invalid @enderror" placeholder="Sort Order" name="sort_order" value="{{$editAds->sort_order}}" autocomplete="off" required>
                                                            @error('sort_order')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
