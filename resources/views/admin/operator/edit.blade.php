                                            ...
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="First Name" name="first_name" value="{{$operator->first_name}}" autocomplete="off">
                                                            @error('first_name')
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            <input type="text" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Last Name" name="last_name" value="{{$operator->last_name}}" autocomplete="off">
                                                            @error('last_name')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            <input type="email" id="name" class="form-control @error('email') is-invalid @enderror" placeholder="Email" name="email" value="{{$operator->email}}" autocomplete="off">
                                                            @error('email')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        <div class="form-label-group">
                                                            <input type="text" id="mobile" class="form-control @error('mobile') is-invalid @enderror" placeholder="Mobile" name="mobile" value="{{$operator->mobile}}" autocomplete="off">
                                                            @error('mobile')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
                                                                </span>
