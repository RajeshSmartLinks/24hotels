                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="whatsapp_number" class="form-control @error('whatsapp_number') is-invalid @enderror" placeholder="Whatsapp Number" name="whatsapp_number" value="{{$editPackage->whatsapp_number}}" autocomplete="off" required>
