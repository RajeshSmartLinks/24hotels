                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" action="{{route('popular-events-news.store')}}" method="post"
                                                    ...
                                                    <div class= "col-md-6 col-12">
                                                        <div class="col-md-6 col-12">
                                                            ...
                                                            <div class="form-label-group">
                                                                ...
                                                                <input type="file" id="image" class="form-control @error('image') is-invalid @enderror" placeholder="Brand Image" name="image" value="{{old('image')}}">
                                                                @error('image')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
