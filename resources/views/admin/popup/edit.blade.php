                ...
                <section class="invoice-print mb-1">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-7 d-flex flex-column flex-md-row justify-content-end">
                            ...
                            <a href="{{route('popup.index')}}" class="btn btn-primary btn-print mb-1 mb-md-0"><i
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form class="form-horizontal" action="{{route('popup.update', $popup->id)}}" method="post"
                                                ...
                                                {{-- <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="pop_up_title" class="form-control @error('pop_up_title') is-invalid @enderror" placeholder="PopUp Title" name="pop_up_title" value="{{old('pop_up_title', $popup->pop_up_title)}}" autocomplete="off"required>
                                                            @error('pop_up_title')
                                                    ...
                                                    <div class= "col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="pop_up_status" class="form-control @error('pop_up_status') is-invalid @enderror" id="basicSelect">
                                                                ...
                                                                <option value="active" {{(old('pop_up_status', $popup->pop_up_status) == "active")?"selected":""}}>Active</option>
                                                                <option value="inactive" {{(old('pop_up_status', $popup->pop_up_status) == "inactive")?"selected":""}}>InActive</option>
                                                            </select>
                                                            @error('pop_up_status')
                                                                <span class="invalid-feedback" role="alert">
                                                                    <strong>{{ $message }}</strong>
