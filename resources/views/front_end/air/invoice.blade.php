      ...
      <td align="center" valign="top"><table class="contenttable" border="0" cellpadding="0" cellspacing="0" width="520" bgcolor="#ffffff" style="border-width:1px;border-style: solid;border-collapse: separate; border-color:#ededed;margin-top:20px; font-family:Arial, Helvetica, sans-serif;padding: 0px 30px;">
                  ...
                  <tr>
                    ...
                    <td valign="top" align="right" style="padding: 9px 0px;">
                      <div style="    width: 200px;">
                        ...
                        <p style=" ">Invoice Number - {{$result['flightBookingDetails']->invoice_id}}<p>
                      </div>
                    </td>
                  </tr>
                 </tbody>
              ...
              <tbody>
                <tr>
                  <td style="font-size:14px;" align="left" width="50%"><div class=""> <strong>Invoiced To:</strong>
                    <br>
                    @if($result['flightBookingDetails']->user_id)
                      {{$result['user']}}
                    @endif
                    <address class="addressstyle">
                      {{$result['flightBookingDetails']->email}}<br />
                      {{$result['flightBookingDetails']->mobile}}<br />
                    </address>
                    </div></td>
                ...
                <tr>
                  <td style="font-size:14px;" align="left" width="50%"><div class=""> <strong>Payment method</strong>
                    <p style="margin-top: 0px">{{$result['flightBookingDetails']->payment_gateway}}</p>
                  
                    </div></td>
                    <td style="font-size:14px;" align="right" width="50%"><div class=""> <strong>Booking date:</strong>
                      <p style="margin-top: 0px">{{date('d-m-Y', strtotime($result['flightBookingDetails']->created_at))}}</p>
                      </div></td>
                ...
                <tbody>
                  ...
                  <tr>
                    <td width="55%" valign="middle" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{$segment['AirLine']->name .' '.$segment['Carrier'].'-'. $segment['FlightNumber']}} -{{$segment['OriginAirportDetails']->city_name .' to '.$segment['DestinationAirportDetails']->city_name }} <br>
                      ...
                      @if($k == 0)
                      <td width="15%" valign="middle"  rowspan="{{count($result['segments'])}}"  align="center" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;padding:7px;line-height:22px;">{{$result['flightBookingDetails']->currency_code .' '.$result['flightBookingDetails']->basefare}} </td>
                    <td width="15%" valign="middle"  rowspan="{{count($result['segments'])}}"  align="center" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;padding:7px;line-height:22px;">{{$result['flightBookingDetails']->currency_code .' '.$result['flightBookingDetails']->tax}} </td>
                    <td width="15%" valign="middle"  rowspan="{{count($result['segments'])}}"  align="center" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;padding:7px;line-height:22px;"> {{$result['flightBookingDetails']->currency_code .' '.$result['flightBookingDetails']->sub_total}} </td>
                    @endif
                  </tr>
                  ...
                  <tr>
                    ...
                    <td style="font-size:13px;border-bottom:1px solid #dddddd;border-right:1px solid #dddddd;background-color:#efefef;font-weight:bold;padding:7px;color:#777777" >{{$result['flightBookingDetails']->currency_code .' '.$result['flightBookingDetails']->actual_amount}}</td>
                  </tr>
                  <tr>
                    <td style="font-size:13px;border-bottom:1px solid #dddddd;background-color:#efefef;font-weight:bold;padding:7px;color:#777777" colspan="3" align="right">
                     <strong>Coupon Amount:</strong> </td>
                    <td style="font-size:13px;border-bottom:1px solid #dddddd;border-right:1px solid #dddddd;background-color:#efefef;font-weight:bold;padding:7px;color:#777777" >- {{$result['flightBookingDetails']->currency_code . !empty($result['flightBookingDetails']->coupon_amount)?$result['flightBookingDetails']->coupon_amount:0 }}</td>
                  </tr>
                  <tr>
                    <td style="font-size:13px;border-bottom:1px solid #dddddd;background-color:#efefef;font-weight:bold;padding:7px;color:#777777" colspan="3" align="right">
                     <strong>Total:</strong> </td>
                    <td style="font-size:13px;border-bottom:1px solid #dddddd;border-right:1px solid #dddddd;background-color:#efefef;font-weight:bold;padding:7px;color:#777777" >{{$result['flightBookingDetails']->currency_code .' '.$result['flightBookingDetails']->total_amount}}</td>
                  </tr>
          ...
          <tr>
            <td class="tablepadding" style="padding:20px 0px 25px;"><table class="" style="border-collapse:collapse;width:100%;border-top:1px solid #dddddd;border-left:1px solid #dddddd;">
                ...
                <tbody>
                  <tr>
                    <td width="25%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{date('d-m-Y', strtotime($result['flightBookingDetails']->created_at))}} </td>
                    <td width="25%" valign="top" align="center" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;padding:7px;line-height:22px;"> {{$result['flightBookingDetails']->payment_gateway}} </td>
                    <td width="25%" valign="top" align="center" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;padding:7px;line-height:22px;"> {{$result['flightBookingDetails']->payment_id}} </td>
                    <td width="25%" valign="top" align="center" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;padding:7px;line-height:22px;"> {{$result['flightBookingDetails']->currency_code .' '.$result['flightBookingDetails']->total_amount}} </td>
                  </tr>
                </tbody>
              </table></td>
          </tr>
