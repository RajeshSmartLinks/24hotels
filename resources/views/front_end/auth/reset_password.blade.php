      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-4">
          <ul class="breadcrumb justify-content-start justify-content-md-end mb-0">
            ...
            <li class="active">{{__('lang.reset_password')}}</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="bg-white shadow-md rounded p-4"> 
            <!-- Reset Password
          ============================================= -->
            <h4 class="mb-4">{{__('lang.reset_password')}}</h4>
            <hr class="mx-n4 mb-4">
            <div class="row g-4">
              <div class="col-lg-8">
                @if (session('error'))
                ...
                <form id="changePassword" method="post" action="{{ route('user-reset.password.post') }}">
                  ...
                  <button class="btn btn-primary" type="submit">{{__('lang.reset_password')}}</button>
                </form>
              </div>
              <div class="col-lg-4"> 
                <!-- Privacy Information
