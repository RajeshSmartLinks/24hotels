    ...
    <td align="center" valign="top"><table class="contenttable" border="0" cellpadding="0" cellspacing="0" width="500" bgcolor="#ffffff" style="border-width:1px; border-style: solid; border-collapse: separate; border-color:#ededed; margin-top:20px;     margin-left: 20px;font-family:Arial, Helvetica, sans-serif">
        ...
        <tr>
          <td style="padding:20px;"><table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody>
                <tr>
                  <td style="font-size:14px; line-height:28px;"><span style="color:#7a7a7a;">PNR -</span> <a style="outline:none; color:#0071cc; text-decoration:none;" href="#">{{$response['universal:UniversalRecord']['@attributes']['LocatorCode']}}</a></td>
                </tr>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td style="font-size:14px; line-height:20px;"><span style="color:#909090">PNR:</span><br />
                    <a style="outline:none; color:#0071cc; text-decoration:none;" href="#">{{$response['universal:UniversalRecord']['@attributes']['LocatorCode']}}</a></td>
