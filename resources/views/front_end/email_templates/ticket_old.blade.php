...
<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
      ...
      <table class="contenttable" border="0" cellpadding="0" cellspacing="0" width="500" bgcolor="#ffffff" style="border-width:1px; border-style: solid; border-collapse: separate; border-color:#ededed; margin-top:20px;     margin-left: 20px;font-family:Arial, Helvetica, sans-serif">
                  ...
                  <td style="border:4px solid #eee; border-radius:4px; padding:25px 0px;"><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                      <tbody>
                        <tr>
                          ...
                          <td style="font-size:16px; font-weight:600; color:#777; line-height:26px; padding-right:20px;"><span style="font-size:13px;">Hi {{$user}} ,
                          </span><br>
                            Congratulations! Your flight booking is <span style="color:#28a745;">confirmed</span>.</td>
                        </tr>
                      </tbody>
                    </table></td>
                </tr>
        ...
        <tr>
          <td style="padding:20px;"><table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tbody>
                @if(count($response['universal:UniversalRecord']['air:AirReservation']['common_v52_0:SupplierLocator']) == 1)
                <tr>
                  <td style="font-size:14px; line-height:28px;"><span style="color:#7a7a7a;">PNR -</span> <a style="outline:none; color:#0071cc; text-decoration:none;" href="#">{{ $response['universal:UniversalRecord']['air:AirReservation']['common_v52_0:SupplierLocator'][0]['@attributes']['SupplierLocatorCode']}}</a></td>
                </tr>
                @endif
                <tr>
        ...
        <tr>
          <td class="tablepadding" style="padding:20px 20px 25px;"><table class="" style="border-collapse:collapse;width:100%;border-top:1px solid #dddddd;border-left:1px solid #dddddd;">
              <tbody>
                ...
                <tr>
                  <td width="60%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{$supplierCode['@attributes']['airline_name']}} </td>
                  <td width="30%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{$supplierCode['@attributes']['SupplierLocatorCode']}}</td>
                </tr>
                @endforeach
              </tbody>
            </table></td>
          ...
          <td class="tablepadding" style="padding:20px 20px 25px;"><table class="" style="border-collapse:collapse;width:100%;border-top:1px solid #dddddd;border-left:1px solid #dddddd;">
              <tbody>
                ...
                <tr>
                  ...
                  ?>
                  <td width="15%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{$TravelerType}} </td>
                  <td width="18%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{$TravelsInfo['common_v52_0:BookingTravelerName']['@attributes']['Prefix']}} </td>
                  <td width="55%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{$TravelsInfo['common_v52_0:BookingTravelerName']['@attributes']['First']}} {{$TravelsInfo['common_v52_0:BookingTravelerName']['@attributes']['Last']}}</td>
                  <td width="22%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;">{{$TravelsInfo['common_v52_0:BookingTravelerName']['@attributes']['TicketNumber']}} </td>
                </tr>
                @endforeach
              </tbody>
            </table></td>
              ...
              <tbody>
                <tr>
                  <td style="font-size:14px; line-height:20px;"><span style="color:#909090">Booking Date:</span><br />
                    <span style="color:#000000;display:inline-block">{{date('d M, Y', strtotime(DateTimeSpliter($response['universal:UniversalRecord']['air:AirReservation']['@attributes']['CreateDate'],"date")))}}</span></td>

                    @if(count($response['universal:UniversalRecord']['air:AirReservation']['common_v52_0:SupplierLocator']) == 1)
                    <td style="font-size:14px; line-height:20px;"><span style="color:#909090">PNR:</span><br />
                      <a style="outline:none; color:#0071cc; text-decoration:none;" href="#">{{ $response['universal:UniversalRecord']['air:AirReservation']['common_v52_0:SupplierLocator'][0]['@attributes']['SupplierLocatorCode']}}</a></td>
                    @endif
                  <td style="font-size:14px; line-height:20px;"><span style="color:#909090">Payment:</span><br />
                    by {{$flightbookingdetails->payment_gateway}}</td>
                </tr>
              </tbody>
            </table></td>
        </tr>
  ...
  @foreach($response['universal:UniversalRecord']['air:AirReservation']['air:AirPricingInfo'][0]['air:BookingInfo'] as $booking)
  <tr>
    <td align="center" valign="top">
      <table class="contenttable" border="0" cellpadding="0" cellspacing="0" width="500" bgcolor="#ffffff" style="border-width:1px; border-style: solid; border-collapse: separate; border-color:#ededed; margin-top:20px;     margin-left: 20px;font-family:Arial, Helvetica, sans-serif">
        <tr>
        ...
        <tr>
          <td class="tablepadding" style="padding:20px;"><table class="" style="border-collapse:collapse;width:100%;border-top:1px solid #dddddd;border-left:1px solid #dddddd;">
              ...
              <tbody>
                <tr>
                  <td width="25%" valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;text-align:left;padding:7px;line-height:22px;"><img style="height: 40px;width:40px" alt="" src="https://www.gstatic.com/flights/airline_logos/70px/{{$booking['@attributes']['segmentDetails']['@attributes']['Carrier']}}.png"><br />
                    {{$booking['@attributes']['segmentDetails']['@attributes']['airLineDetais']->name}}<br />
                    <span style="font-size:13px; color:#555;">{{$booking['@attributes']['segmentDetails']['@attributes']['Carrier']}}-{{$booking['@attributes']['segmentDetails']['@attributes']['FlightNumber']}}</span></td>
                  <td valign="top" style="border-right:1px solid #dddddd;border-bottom:1px solid #dddddd;padding:7px;line-height:22px;">  {{$booking['@attributes']['segmentDetails']['@attributes']['OriginAirportDetails']->city_name}} ({{$booking['@attributes']['segmentDetails']['@attributes']['Origin']}})<br />
                    <span style="font-size:14px; color:#111111;">{{date('d M Y', strtotime(DateTimeSpliter($booking['@attributes']['segmentDetails']['@attributes']['DepartureTime'],"date")))}} &nbsp; {{DateTimeSpliter($booking['@attributes']['segmentDetails']['@attributes']['DepartureTime'],"time")}}</span><br />
