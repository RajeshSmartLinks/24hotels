      ...
      <div class="row"> 
        ...
        <div class="col-lg-9 mt-4 mt-lg-0"> 
          ...
          <div class="hotels-list">
            ...
            <div class="hotels-item bg-white shadow-md rounded p-3" data-pricing = "{{$hotelDetails['markups']['totalPrice']['value']}}" data-refund = "{{$hotelDetails['isRefundable'] == '1' ? 'refundable':'non-refundable'}}" data-rating = "{{$ratingval}}" data-hotelname ="{{$hotelDetails['hotelName']}}">
              <div class="row">
                  ...
                  <div class="row g-0">
                    <div class="col-sm-9">
                      ...
                      <p class="mb-2" style="display: -webkit-box;-webkit-box-orient: vertical;-webkit-line-clamp: 3;overflow: hidden;text-overflow: ellipsis;"> <span class="me-2">
                        ...
                        @endfor
                        </span> <span class="text-black-50"><i class="fas fa-map-marker-alt"></i> &nbsp;{{$hotelDetails['address']}}</span> </p>
                        <div class="row">
                            <div class="col-5">
                    ...
                    <div class="col-sm-3 text-end d-flex d-sm-block align-items-center">
                      ...
                      <div class="text-black-50 mb-0 mb-sm-2 order-3 d-none d-sm-block">{{count($hotelDetails['rooms'])}} {{__('lang.room')}} / {{$result['searchRequest']['no_of_nights']}} {{__('lang.night')}}</div>
