      ...
      <div class="row"> 
        ...
        <div class="col-lg-8">
          <div class="bg-white shadow-md rounded p-3 p-sm-4 confirm-details"> 
            ...
            <div class="row mb-3">
              ...
              <div class="col-6 col-xl-6"><span class="text-muted text-3 me-2"><i class="fas fa-sign-in-alt"></i></span><span class= "text-uppercase fw-700">{{__('lang.checkin')}} : </span>{{$result['hotelDeatils']['check_in'] ?? '---'}}</div>
              <div class="col-6 col-xl-6"><span class="text-muted text-3 me-2"><i class="fas fa-sign-out-alt"></i></span><span class= "text-uppercase fw-700">{{__('lang.checkout')}} : </span> {{$result['hotelDeatils']['check_out'] ?? '---'}}</div>
            </div>
            <hr class="mb-4">
        ...
        <aside class="col-lg-4 mt-4 mt-lg-0">
          <div class="bg-white shadow-md rounded p-3 ">
            <p class="reviews text-center">  <span class="fw-600">{{__('lang.hotel_rating')}}</span> &nbsp; <span class="reviews-score rounded fw-600 text-white px-2 py-1">{{$result['hotelDeatils']['hotel_rating']}}</span>  </p>
            <hr class="mx-n3">
