...
<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
  <tr>
    <td align="center" valign="top">
      <table class="contenttable" border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff" style="border-width:1px; border-style: solid; border-collapse: separate; border-color:#ededed; margin-top:20px; margin-left: 20px; font-family:Arial, Helvetica, sans-serif">
        ...
        @if(!empty($result['hotel_booking_Details']->cancellation_rules))
          <tr>
            <td style="padding:10px 20px;"><h3 style="margin:0; font-weight:normal; color:#444444;">Cancellation Policies</h3></td>
          </tr>
          @foreach ($result['hotel_booking_Details']->cancellation_rules as $roomKey => $roomCancellation_rules)
            <tr>
