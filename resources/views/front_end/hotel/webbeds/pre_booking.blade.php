      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="bg-white shadow-md rounded p-3 p-sm-4 confirm-details">
            ...
            <div class="row">
              <div class="col-12 col-md-3 mb-3 mb-md-0"> <img class="img-fluid rounded align-top" src="{{$result['hotelDetails']['thumbnail']}}" alt="hotels" onError="this.onerror=null;this.src='{{ asset('frontEnd/images/no-hotel-image.png') }}';"style="height:107px;" title="Standard Room" alt="Standard Room"> </div>
            ...
            @if(!empty($result['roomDetails']))
                <div class="bg-white shadow-md rounded p-3">
                    ...
                    <p class="text-muted d-flex align-items-center justify-content-center mt-3 mb-1">
                      ...
                      <a href="#" data-bs-toggle="modal" data-bs-target="#cancellation-policy" style="color: red;">{{__('lang.cancellation_policy')}}</a>
                      <div id="cancellation-policy" class="modal fade" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
