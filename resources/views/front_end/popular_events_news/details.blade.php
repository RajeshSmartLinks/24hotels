  ...
  <section class="page-header page-header-dark bg-secondary">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-8">
          <h1>{{__('lang.popular_events_and_news_details')}} </h1>
        </div>
        <div class="col-md-4">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-start justify-content-md-end mb-0">
              ...
              <li class="breadcrumb-item"><a href="{{route('offers')}}">{{__('lang.popular_events_and_news')}} </a></li>
      ...
      <div class="row"> 
        ...
        <div class="col-lg-8 col-xl-9">
          <div class="blog-post card shadow-sm border-0 mb-4 p-4">
            <h2 class="title-blog text-7">{{$popularEvents->name}}</h2>
            ...
            <img class="img-fluid" src="{{asset('uploads/popular_events_news/'.$popularEvents->image)}}" alt="">
